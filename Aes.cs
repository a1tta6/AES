...
namespace AES
{
    public class AES
    {
        ...
        private static int Nb,  // число столбцов(32-ух битных слов), составляющих State. Для, AES Nb = 4
        ...
        // Табличная замена над каждым байтом входного значения
        ...
        // Наложение раундового ключа на массив данных
        ...
        // Циклический сдвиг влево строк массива данных
        ...
        // Циклический сдвиг вправо строк массива данных
        ...
        // Умножение каждого столбца массива данных на полином a^(-1)(x) = Bx^3+Dx^2+9x+E
        ...
        // Умножение каждого столбца массива данных на полином a(x) = 3x^3+x^2+x+2
        ...
        /// Функция шифрования
        /// </summary>
        /// <param name="inp"> Шифруемый текст</param>
        ...
        /// </summary>
        /// <param name="inp"> Зашифрованный текст</param>
        /// <param name="key"> Ключ</param>
        /// <returns></returns>
